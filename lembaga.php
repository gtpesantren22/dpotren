                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $r['nama'] ?></td>
                                                    <td><?= $r['tahun'] ?></td>
                                                    <td><a href="<?= 'hapus.php?kd=lmb&id=' . $r['id_lembaga'] ?>" onclick="return confirm('Yakiin akan dihapus ?')"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Dele</button></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
