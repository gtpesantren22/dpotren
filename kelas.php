    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Data Kelas Formal</h4>
                        <div class="row">
                            <div class="col-md-7">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $r['nama'] ?></td>
                                                    <td><?= $r['tahun'] ?></td>
                                                    <td><a href="<?= 'hapus.php?kd=fr&id=' . $r['id_kelas'] ?>" onclick="return confirm('Yakiin akan dihapus ?')"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Dele</button></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
